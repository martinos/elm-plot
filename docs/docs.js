...
var _terezka$elm_plot$Plot$toBarWidth = F3(
	function (length, range, _p23) {
		var _p24 = _p23;
		var range = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, _p24.points);
		var _p25 = {
			ctor: '_Tuple2',
		...
		var lowestX = _p25._0;
		var highestX = _p25._1;
		var widthAuto = length / (highestX - lowestX);
		var _p26 = _p24.maxWidth;
		if (_p26.ctor === 'AutoMaxWidth') {
			return widthAuto;
		} else {
			var _p27 = _p26._0;
			return (_elm_lang$core$Native_Utils.cmp(widthAuto, _p27) > 0) ? _p27 : widthAuto;
		}
	});
var _terezka$elm_plot$Plot$toBar = F3(
	function (width, originY, _p28) {
		var _p29 = _p28;
		var _p30 = _p29._1;
		return A2(
			_elm_lang$svg$Svg$rect,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$x(
					_elm_lang$core$Basics$toString(_p29._0 - (width / 2))),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$height(
								_elm_lang$core$Basics$toString(originY - _p30)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _terezka$elm_plot$Plot$viewBars = F2(
	function (_p32, _p31) {
		var _p33 = _p32;
		var _p37 = _p33.toSvgCoords;
		var _p36 = _p33.scale;
		var _p34 = _p31;
		var width = A3(_terezka$elm_plot$Plot$toBarWidth, _p36.length, _p36.range, _p34);
		var _p35 = _p37(
			{ctor: '_Tuple2', _0: 0, _1: 0});
		var originY = _p35._1;
		var svgPoints = A2(_elm_lang$core$List$map, _p37, _p34.points);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p34.style)),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A2(_terezka$elm_plot$Plot$toBar, width, originY),
				svgPoints));
	});
var _terezka$elm_plot$Plot$toSvgCircle = F2(
	function (radius, _p38) {
		var _p39 = _p38;
		return A2(
...
var _terezka$elm_plot$Plot$viewScatter = F2(
	function (_p41, _p40) {
		var _p42 = _p41;
		var _p43 = _p40;
		var svgPoints = A2(_elm_lang$core$List$map, _p42.toSvgCoords, _p43.points);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p43.style)),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				_terezka$elm_plot$Plot$toSvgCircle(_p43.radius),
				svgPoints));
	});
var _terezka$elm_plot$Plot$viewArea = F2(
	function (_p45, _p44) {
		var _p46 = _p45;
		var _p52 = _p46.toSvgCoords;
		var _p47 = _p44;
		var _p51 = _p47.points;
		var svgCoords = A2(_elm_lang$core$List$map, _p52, _p51);
		var instructions = A2(_terezka$elm_plot$Helpers$coordToInstruction, 'L', svgCoords);
		var range = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, _p51);
		var _p48 = {
			ctor: '_Tuple2',
			_0: _terezka$elm_plot$Helpers$getLowest(range),
			_1: _terezka$elm_plot$Helpers$getHighest(range)
		...
		var lowestX = _p48._0;
		var highestX = _p48._1;
		var _p49 = _p52(
			{ctor: '_Tuple2', _0: highestX, _1: 0});
		var highestSvgX = _p49._0;
		var originY = _p49._1;
		...
		return A2(
			_elm_lang$svg$Svg$path,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$style(
						_terezka$elm_plot$Helpers$toStyle(_p47.style)),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
...
var _terezka$elm_plot$Plot$viewGridLine = F4(
	function (toSvgCoords, scale, style, position) {
		var _p53 = scale;
		var lowest = _p53.lowest;
		var highest = _p53.highest;
		var _p54 = toSvgCoords(
			{ctor: '_Tuple2', _0: lowest, _1: position});
		var x1 = _p54._0;
		var y1 = _p54._1;
		var _p55 = toSvgCoords(
...
var _terezka$elm_plot$Plot$viewGrid = F2(
	function (_p58, _p57) {
		var _p59 = _p58;
		var _p60 = _p57;
		var positions = A2(_terezka$elm_plot$Plot$getGridPositions, _p59.oppositeTicks, _p60.values);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class(
					A2(_elm_lang$core$String$join, ' ', _p60.classes)),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A3(_terezka$elm_plot$Plot$viewGridLine, _p59.toSvgCoords, _p59.scale, _p60.style),
				positions));
	});
...
var _terezka$elm_plot$Plot$defaultLabelView = F4(
	function (_p61, orientation, index, tick) {
		var _p62 = _p61;
		var _p63 = A3(
			F2(
				function (x, y) {
		...
		var defaultStyle = _p63._0;
		var defaultDisplacement = _p63._1;
		var _p64 = A2(_elm_lang$core$Maybe$withDefault, defaultDisplacement, _p62.displace);
		var dx = _p64._0;
		var dy = _p64._1;
		return A2(
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Attributes$style(
						_terezka$elm_plot$Helpers$toStyle(
							A2(_elm_lang$core$Basics_ops['++'], defaultStyle, _p62.style))),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class(
							A2(_elm_lang$core$String$join, ' ', _p62.classes)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _terezka$elm_plot$Plot$defaultTickView = F4(
	function (_p67, orientation, _p66, _p65) {
		var _p68 = _p67;
		var styleFinal = A2(
			_elm_lang$core$Basics_ops['++'],
			_p68.style,
			{
				...
				_0: {
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_p68.width),
						'px')
				},
				_1: {ctor: '[]'}
			});
		...
		return A2(
			_elm_lang$svg$Svg$line,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y2(
						_elm_lang$core$Basics$toString(_p68.length)),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class(
								A2(_elm_lang$core$String$join, ' ', _p68.classes)),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		return A2(
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					_terezka$elm_plot$Helpers$toTranslate(
						_p71.toSvgCoords(
							{ctor: '_Tuple2', _0: _p73, _1: 0}))),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(view, _p72._0, _p73),
				_1: {ctor: '[]'}
			});
	});
...
var _terezka$elm_plot$Plot$viewAxis = F2(
	function (plotProps, _p74) {
		var _p75 = _p74;
		var _p80 = _p75.orientation;
		var _p76 = plotProps;
		var scale = _p76.scale;
		var oppositeScale = _p76.oppositeScale;
		var toSvgCoords = _p76.toSvgCoords;
		var oppositeToSvgCoords = _p76.oppositeToSvgCoords;
		var tickPositions = _terezka$elm_plot$Plot$indexTicks(
			A2(
				_terezka$elm_plot$Plot$filterTicks,
				_p75.axisCrossing,
				_p75.toTickValues(scale)));
		var labelPositions = function () {
			var _p77 = _p75.labelValues;
			if (_p77.ctor === 'LabelCustomValues') {
				return _terezka$elm_plot$Plot$indexTicks(_p77._0);
			} else {
				return A2(
					_elm_lang$core$List$filter,
					function (_p78) {
						var _p79 = _p78;
						return A2(_p77._0, _p79._0, _p79._1);
					},
					tickPositions);
			}
		}();
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p75.style)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$class(
						A2(_elm_lang$core$String$join, ' ', _p75.classes)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: A4(_terezka$elm_plot$Plot$viewGridLine, toSvgCoords, scale, _p75.axisLineStyle, 0),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
	...
	function (plotProps, element, views) {
		...
		switch (_p81.ctor) {
			case 'Axis':
				...
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewAxis, plotPropsFitted, _p83),
					_1: views
				};
			case 'Grid':
				var _p85 = _p81._0;
				var plotPropsFitted = function () {
					var _p84 = _p85.orientation;
					if (_p84.ctor === 'X') {
						return plotProps;
					} else {
						return _terezka$elm_plot$Plot$flipToY(plotProps);
				...
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewGrid, plotPropsFitted, _p85),
					_1: views
				};
			case 'Line':
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewLine, plotProps, _p81._0),
					_1: views
				};
			case 'Area':
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewArea, plotProps, _p81._0),
					_1: views
				};
			case 'Scatter':
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewScatter, plotProps, _p81._0),
					_1: views
				};
			default:
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$viewBars, plotProps, _p81._0),
					_1: views
				};
		}
	});
			...
			_elm_lang$svg$Svg$svg,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$style(
							_terezka$elm_plot$Helpers$toStyle(_p87.style)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class(
								A2(_elm_lang$core$String$join, ' ', _p87.classes)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _terezka$elm_plot$Plot$barsStyle = F2(
	function (style, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{style: style});
...
var _terezka$elm_plot$Plot$BarsConfig = F3(
	function (a, b, c) {
		return {style: a, points: b, maxWidth: c};
	});
...
var _terezka$elm_plot$Plot$Bars = function (a) {
	return {ctor: 'Bars', _0: a};
};
...
var _terezka$elm_plot$Plot$getPlotProps = F2(
	function (_p96, elements) {
		...
		var yScale = A3(_terezka$elm_plot$Plot$getScales, height, _p97.padding, yValues);
...
var _terezka$elm_plot$Plot$MaxWidth = function (a) {
	return {ctor: 'MaxWidth', _0: a};
};
var _terezka$elm_plot$Plot$barsMaxWidth = F2(
	function (max, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				maxWidth: _terezka$elm_plot$Plot$MaxWidth(
					_elm_lang$core$Basics$toFloat(max))
			});
	});
var _terezka$elm_plot$Plot$AutoMaxWidth = {ctor: 'AutoMaxWidth'};
var _terezka$elm_plot$Plot$defaultBarsConfig = {
	style: {ctor: '[]'},
	points: {ctor: '[]'},
	maxWidth: _terezka$elm_plot$Plot$AutoMaxWidth
};
var _terezka$elm_plot$Plot$bars = F2(
	function (attrs, points) {
		var config = A3(
			_elm_lang$core$List$foldr,
			F2(
			...
			_terezka$elm_plot$Plot$defaultBarsConfig,
			attrs);
		return _terezka$elm_plot$Plot$Bars(
			_elm_lang$core$Native_Utils.update(
				config,
				{points: points}));
	});
...
var _terezka$elm_plot$Colors$pinkFill = '#fdb9e7';
var _terezka$elm_plot$Colors$skinStroke = '#f7e0d2';
var _terezka$elm_plot$Colors$skinFill = '#feefe5';
var _terezka$elm_plot$Colors$blueStroke = '#cfd8ea';
var _terezka$elm_plot$Colors$blueFill = '#e4eeff';
...
var _terezka$elm_plot$AreaChart$data = {
	ctor: '::',
...
var _terezka$elm_plot$AreaChart$chart = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot$areaStyle(
					{
						ctor: '::',
...
var _terezka$elm_plot$BarsChart$code = '\n    chart : Svg.Svg a\n    chart =\n        plot\n            [ size ( 600, 250 ) ]\n            [ bars\n                [ barsStyle\n                    [ ( \"stroke\", Colors.pinkStroke )\n                    , ( \"fill\", Colors.pinkFill )\n                    ]\n                , barsRadius 8\n                ]\n                data\n            , xAxis [ axisStyle [ ( \"stroke\", Colors.axisColor ) ] ]\n            ]\n    ';
var _terezka$elm_plot$BarsChart$data = {
	ctor: '::',
...
var _terezka$elm_plot$BarsChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot$barsStyle(
					{
						ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot$barsMaxWidth(50),
					_1: {ctor: '[]'}
				}
			},
			_terezka$elm_plot$BarsChart$data),
		_1: {
			ctor: '::',
...
var _terezka$elm_plot$ComposedChart$customLabelStyle = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#969696'},
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$ComposedChart$isOdd = function (n) {
	return _elm_lang$core$Native_Utils.cmp(
		A2(_elm_lang$core$Basics$rem, n, 2),
		0) > 0;
};
var _terezka$elm_plot$ComposedChart$filterLabels = F2(
	function (index, _p0) {
		return !_terezka$elm_plot$ComposedChart$isOdd(index);
	});
var _terezka$elm_plot$ComposedChart$toTickConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$ComposedChart$isOdd(index) ? {
			ctor: '::',
			_0: _terezka$elm_plot$Plot$tickLength(7),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot$tickStyle(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#c7c7c7'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
			...
			ctor: '::',
			_0: _terezka$elm_plot$Plot$tickLength(10),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot$tickStyle(
					{
...
var _terezka$elm_plot$ComposedChart$data1 = {
	ctor: '::',
...
var _terezka$elm_plot$ComposedChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
			{ctor: '_Tuple2', _0: 600, _1: 350}),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: _terezka$elm_plot$Plot$horizontalGrid(
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot$gridMirrorTicks,
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot$gridStyle(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#f2f2f2'},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		_1: {
			...
			_0: A2(
				...
				A2(
					...
					function (_p1) {
						var _p2 = _p1;
						return {ctor: '_Tuple2', _0: _p2._0, _1: _p2._1 * 2.1};
					},
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot$lineStyle(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$pinkStroke},
									_1: {
						...
						A2(
							...
							function (_p3) {
								var _p4 = _p3;
								return {ctor: '_Tuple2', _0: _p4._0, _1: _p4._1 * 3};
							},
							_terezka$elm_plot$ComposedChart$data1)),
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot$yAxis(
							{
								...
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot$tickRemoveZero,
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot$tickDelta(50),
										_1: {
											ctor: '::',
											_0: _terezka$elm_plot$Plot$labelConfigView(
												{
													ctor: '::',
													_0: _terezka$elm_plot$Plot$labelFormat(
														function (l) {
															return A2(
																_elm_lang$core$Basics_ops['++'],
													...
													_1: {
														ctor: '::',
														_0: _terezka$elm_plot$Plot$labelStyle(_terezka$elm_plot$ComposedChart$customLabelStyle),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
							...
							_0: _terezka$elm_plot$Plot$xAxis(
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _terezka$elm_plot$Plot$tickConfigViewFunc(_terezka$elm_plot$ComposedChart$toTickConfig),
											_1: {
												ctor: '::',
												_0: _terezka$elm_plot$Plot$labelConfigView(
													{
												...
												_1: {
													ctor: '::',
													_0: _terezka$elm_plot$Plot$labelFilter(_terezka$elm_plot$ComposedChart$filterLabels),
													_1: {ctor: '[]'}
												}
											}
										}
		...
		return _terezka$elm_plot$CustomTickChart$isOdd(index) ? {
			...
			_1: {
				...
				_0: _terezka$elm_plot$Plot$tickStyle(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#e4e3e3'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _terezka$elm_plot$CustomTickChart$toLabelConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$CustomTickChart$isOdd(index) ? {
			ctor: '::',
			_0: _terezka$elm_plot$Plot$labelFormat(
			...
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot$labelStyle(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#969696'},
						_1: {ctor: '[]'}
				...
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot$labelDisplace(
						{ctor: '_Tuple2', _0: 0, _1: 27}),
					_1: {ctor: '[]'}
				}
			}
		};
	});
var _terezka$elm_plot$CustomTickChart$data = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: 14},
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$CustomTickChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot$tickConfigViewFunc(_terezka$elm_plot$CustomTickChart$toTickConfig),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot$labelConfigViewFunc(_terezka$elm_plot$CustomTickChart$toLabelConfig),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _terezka$elm_plot$MultiAreaChart$data2 = {
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 30, _1: 12},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 40, _1: 20},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 45, _1: 25},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 50, _1: 3},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _terezka$elm_plot$MultiAreaChart$data1 = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: 10},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 10, _1: 90},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 20, _1: 25},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 30, _1: 15},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 40, _1: 66},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 50, _1: 16},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _terezka$elm_plot$MultiAreaChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
	...
	},
	{
		...
		_0: A2(
			...
			_terezka$elm_plot$MultiAreaChart$data1),
		_1: {
			ctor: '::',
			_0: A2(
				_terezka$elm_plot$Plot$area,
				...
				_terezka$elm_plot$MultiAreaChart$data2),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot$xAxis(
					{
						...
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot$tickDelta(10),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 8, _1: 31},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 9, _1: 37},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 10, _1: 42},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _terezka$elm_plot$GridChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
	...
	},
	{
		...
		_0: _terezka$elm_plot$Plot$verticalGrid(
			{
				...
				_1: {
					...
					_0: _terezka$elm_plot$Plot$gridStyle(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$axisColorLight},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		_1: {
			...
			_0: _terezka$elm_plot$Plot$horizontalGrid(
				{
					ctor: '::',
					_0: _terezka$elm_plot$Plot$gridValues(
						{
							ctor: '::',
							_0: 10,
							_1: {
...
var _terezka$elm_plot$MultiLineChart$code = '\n    chart : Svg.Svg a\n    chart =\n        plot\n            [ size ( 600, 250 ) ]\n            [ line\n                [ lineStyle\n                    [ ( \"stroke\", Colors.blueStroke )\n                    , ( \"stroke-width\", \"2px\" )\n                    ]\n                ]\n                data2\n            , line\n                [ lineStyle\n                    [ ( \"stroke\", Colors.pinkStroke )\n                    , ( \"stroke-width\", \"2px\" )\n                    ]\n                ]\n                data1\n            , xAxis\n                [ axisStyle [ ( \"stroke\", Colors.axisColor ) ]\n                ]\n            ]\n    ';
var _terezka$elm_plot$MultiLineChart$data2 = {
	ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 5.5, _1: 15},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 6.5, _1: 14},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 7.5, _1: 13},
										_1: {
											ctor: '::',
...
var _terezka$elm_plot$MultiLineChart$data1 = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: 8},
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$MultiLineChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
...
var _terezka$elm_plot$Docs$viewTitle = F4(
	function (model, title, name, codeString) {
		var isOpen = function () {
			var _p1 = model;
			if (_p1.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p1._0, title);
			} else {
				return false;
			}
		}();
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('View code snippet'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A4(_terezka$elm_plot$Docs$viewTitle, model, 'Simple Area Chart', 'AreaChart', _terezka$elm_plot$AreaChart$code),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$AreaChart$chart,
							_1: {
								ctor: '::',
								_0: A4(_terezka$elm_plot$Docs$viewTitle, model, 'Multi Area Chart', 'MultiAreaChart', _terezka$elm_plot$MultiAreaChart$code),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$MultiAreaChart$chart,
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: A4(_terezka$elm_plot$Docs$viewTitle, model, 'Bars Chart', 'BarsChart', _terezka$elm_plot$BarsChart$code),
														_1: {
															ctor: '::',
															_0: _terezka$elm_plot$BarsChart$chart,
															_1: {
																ctor: '::',
